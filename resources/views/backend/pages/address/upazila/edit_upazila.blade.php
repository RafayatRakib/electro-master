        ...
        <div class="my-5">
            ...
            <div class="card mb-4">
                <div class="d-flex justify-content-between">
                    <h5 class="card-header">Edit Upazila</h5>
                    <div class="mt-3 mx-3">
                        <a class="btn btn-dark" href="{{route('admin.all.upazila')}}">All Upazila</a>
                    </div>
                </div>
                <div class="card-body">
                <form action="{{route('upazila.update')}}" method="post">
                    @csrf
                  <div>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="defaultSelect" name="district" class="form-select @error('district') is-invalid @enderror">
                          ...
                          <option selected value="{{$upazila->district_id}}">--{{$upazila->district->district_name}}</option>
                    ...
                    <input type="text" name="upazila" value="{{$upazila->upazila_name}}" class="form-control @error('upazila')is-invalid @enderror"  placeholder="Ex: Sonargaon" aria-describedby="defaultFormControlHelp">
                    @error('upazila') 
