    ...
    <div class="container">
        <div class="my-5">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                <form action="{{route('store.employer')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="my-3">
                        <label for="defaultFormControlInput" class="form-label">Name</label>
                        <input type="text" name="name" id="name" class="form-control @error('name')is-invalid @enderror" id="defaultFormControlInput" value="{{old('name')}}" placeholder="Ex: Jone Doe" aria-describedby="defaultFormControlHelp">
                    ...
                    <div class="my-3">
                        ...
                        <input type="text" name="nid" id="nid" class="form-control @error('nid')is-invalid @enderror" id="defaultFormControlInput" value="{{old('nid')}}" placeholder="Ex: CRISMAS007" aria-describedby="defaultFormControlHelp">
                    ...
                    <div class="my-3">
                        ...
                        <input type="text" name="Phone" id="Phone" class="form-control @error('Phone')is-invalid @enderror" id="defaultFormControlInput" value="{{old('Phone')}}" placeholder="Ex: +8801612-151515" aria-describedby="defaultFormControlHelp">
                        @error('Phone') <strong class="text-danger">{{$message}}</strong> @enderror <br>
                    </div>
                    <div class="my-3">
                        <label for="defaultFormControlInput" class="form-label">Email</label>
                        <input type="email" name="email" id="email" class="form-control @error('email')is-invalid @enderror" id="defaultFormControlInput" value="{{old('email')}}" placeholder="Ex: +8801612-151515" aria-describedby="defaultFormControlHelp">
                    ...
                    <div class="my-3">
                        ...
                        <textarea name="address" class="form-control" cols="30" rows="5" value="{{old('address')}}" placeholder="Enter address here"></textarea>
                    ...
                    <div class="my-3">
                        ...
                        <input name="date_of_birth" type="datetime-local" class="form-control">
