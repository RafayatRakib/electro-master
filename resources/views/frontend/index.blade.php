               ...
               <div class="products-tabs">
				  ...
				  <div id="tab1" class="tab-pane active">
					  <div class="products-slick" data-nav="#slick-nav-1">
				  		@php
                        	$product = App\Models\FlashSalesProduct::get();
                        @endphp
                	 @forelse ($product as $item)
                        ...
                        @if ($item->flashsale->discount_type == 'cash')
							   <h4 class="product-price">{!!$currency->currency_symbol!!}{{number_format(($item->product->product_price-$item->flashsale->discount),2,'.',',')<= 0 ? $item->product->product_price : number_format(($item->product->product_price-$item->flashsale->discount),2,'.',',')}}<del class="product-old-price">{!!$currency->currency_symbol!!}{{number_format($item->product->product_price, 2, '.', ',')}}</del></h4>
							   {{-- @else
							   <h4 class="product-price">{!!$currency->currency_symbol!!}{{number_format($item->product->product_price, 2, '.', ',')}}</h4> --}}
							   @endif
                      </a>
